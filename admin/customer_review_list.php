        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Customer's Details</li>
              <li class="breadcrumb-item active">Active Customer List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">CUSTOMER REVIEW LIST</h3> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tr class="table-warning">
                    ...
                    <th>Review</th>
                    <th>Profile</th>
                    <th>Review Send to User(Profile)</th>
                    <th>Create Date</th>
                  </tr>
