...
include "include/header.php";
  $url = $URL."user/read_user_wall.php";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">New Post Request List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">NEW POST REQUEST LIST</h3> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>          
                    ...
                    <a href="<?php echo $USER_WALL_IMGPATH.$value1->userId."/".$value1->wallImg; ?>" target="_blank">
                      <img class="img img-fluid img-thumbnail" width="250" height="250" src="<?php echo $USER_WALL_IMGPATH.$value1->userId."/".$value1->wallImg; ?>">
                     </a>
                    </td>
